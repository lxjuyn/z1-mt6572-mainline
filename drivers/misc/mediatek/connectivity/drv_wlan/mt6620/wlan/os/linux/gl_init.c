...
/* mainline 7.0: MODULE_SUPPORTED_DEVICE 宏已移除(v5.4+), 调用会让 NIC_NAME 字符串成裸声明触发 version.h:132 编译错, 注释掉。*/
...
{
    (void)sb_dev;  /* mainline 7.0 ndo_select_queue 多此 sb_dev 参, 驱动用不到 */
...
static void wlanEarlySuspend(void)
{
    ...
    UINT_8  ip[4] = { 0 };
    UINT_32 u4NumIPv4 = 0;
    UINT_32 u4NumIPv6 = 0;  /* mainline: 外编 M= 不喂 CONFIG_IPV6, u4NumIPv6 移出 ifdef 给默认0声明 */
#ifdef  CONFIG_IPV6
